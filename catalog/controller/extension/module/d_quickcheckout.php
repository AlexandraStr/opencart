...
$this->load->model('extension/d_quickcheckout/address');
        ...
        $field_count = array(
            ...
            'company' => array('payment_address' => 0, 'shipping_address' => 0, 'confirm' => 0),
        ...
        if($this->setting['general']['clear_session']){
            ...
            $this->session->data['payment_address'] = array(
                ...
                'confirm' => '',
                'customer_group_id' => $this->config->get('config_customer_group_id'),
                'code_company' => $this->setSessionValue('code_company','payment_address', $data, $account, false),
            ...
            $this->session->data['shipping_address'] = array(
                ...
                'code_company' => $this->setSessionValue('code_company','shipping_address', $data, $account, false),
            ...
            $this->session->data['payment_address'] = array(
                ...
                'confirm' => '',
                'customer_group_id' => $customer_group_id ,
                'code_company' => $this->setSessionValue('code_company','payment_address', $data, $account),
            ...
            $this->session->data['shipping_address'] = array(
                ...
                'code_company' =>  $this->setSessionValue('code_company','shipping_address', $data, $account),
