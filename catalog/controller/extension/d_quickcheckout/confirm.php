...
class ControllerExtensionDQuickcheckoutConfirm extends Controller {
            ...
            if($this->session->data['account'] == 'register'){
                ...
                $showShippingAddress = $this->model_extension_d_quickcheckout_address->showShippingAddress();
                 ...
                 $this->session->data['payment_address']['custom_field']=  array(
                     'account' => array(
                                 '1' => (!empty($this->request->post['payment_address']['code_company'])) ? $this->request->post['payment_address']['code_company'] : $this->session->data['company']['code_company'],
                                 '2' => (!empty($this->request->post['payment_address']['company'])) ? $this->request->post['payment_address']['company'] : $this->session->data['company']['company'],
                                  )
                          );
    ...
    public function updateOrder(){
        ...
        } elseif (isset($this->session->data['company'])) {
            $order_data['customer_id'] = 0;
            $order_data['customer_group_id'] = $this->session->data['company']['customer_group_id'];
            $order_data['firstname'] = $this->session->data['company']['firstname'];
            $order_data['lastname'] = $this->session->data['company']['lastname'];
            $order_data['email'] = $this->session->data['company']['email'];
            $order_data['telephone'] = $this->session->data['company']['telephone'];
            $order_data['fax'] = $this->session->data['company']['fax'];
            $order_data['custom_field'] = (isset($this->session->data['company']['custom_field']['account'])) ? $this->session->data['company']['custom_field']['account'] : array();
    }
        ...
        $order_data['payment_code_company'] = $this->session->data['payment_address']['code_company'];
        ...
        if ($this->cart->hasShipping()) {
            ...
            $order_data['shipping_code_company'] = $this->session->data['shipping_address']['code_company'];
            ...
            $order_data['shipping_code_company'] = '';
