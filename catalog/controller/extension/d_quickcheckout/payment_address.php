...
class ControllerExtensionDQuickcheckoutPaymentAddress extends Controller {
    ...
    public function prepare($json){
        ...
        if($this->customer->isLogged()){
            ...
            $this->session->data['company'] = array(
                'customer_group_id' => (!empty($this->request->post['payment_address']['customer_group_id'])) ? $this->request->post['payment_address']['customer_group_id'] : $this->session->data['company']['customer_group_id'],
                'firstname' => (!empty($this->request->post['payment_address']['firstname'])) ? $this->request->post['payment_address']['firstname'] : $this->session->data['company']['firstname'],
                'lastname' => (!empty($this->request->post['payment_address']['lastname'])) ? $this->request->post['payment_address']['lastname'] : $this->session->data['company']['lastname'],
                'code_company' => (!empty($this->request->post['payment_address']['code_company'])) ? $this->request->post['payment_address']['code_company'] : $this->session->data['company']['code_company'],
                'company' => (!empty($this->request->post['payment_address']['company'])) ? $this->request->post['payment_address']['company'] : $this->session->data['company']['company'],

                'email' => (!empty($this->request->post['payment_address']['email'])) ? $this->request->post['payment_address']['email'] : $this->session->data['company']['email'],
                'telephone' => (!empty($this->request->post['payment_address']['telephone'])) ? $this->request->post['payment_address']['telephone'] : $this->session->data['company']['telephone'],
                'fax' => (!empty($this->request->post['payment_address']['fax'])) ? $this->request->post['payment_address']['fax'] : $this->session->data['company']['fax'],
                'custom_field' => (!empty($this->request->post['payment_address']['custom_field'])) ? $this->request->post['payment_address']['custom_field'] :  array('account' => array()),
                'shipping_address' => (!empty($this->request->post['payment_address']['shipping_address'])) ? $this->request->post['payment_address']['shipping_address'] : $this->session->data['company']['shipping_address'],
            );
