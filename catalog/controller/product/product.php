...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $data['technical_description'] = html_entity_decode($product_info['technical_description'], ENT_QUOTES, 'UTF-8');
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'technical_description' => trim(strip_tags(html_entity_decode($result['description'], ENT_QUOTES, 'UTF-8'))),
                    'price'       => $price,
					'special'     => $special,
					'tax'         => $tax,
