...
$_['text_order_quantity'] =  'Количество для заказа';
...
$_['text_model_desc']   = 'Код тлвара (Я - А)';
$_['text_limit']        = 'Показать:';
$_['text_warning']      ='Нет на складе';
$_['text_danger']       ='Количество ограничено';
$_['text_success']      ='Есть на складе';
$_['text_no_results']   ='Не найдены товары даного производителя'; 
