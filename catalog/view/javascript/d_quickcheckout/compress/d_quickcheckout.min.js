...
emailVal=email.val();var that=this;$.ajax({url:"index.php?route=extension/d_quickcheckout/field/validate_email",async:true,method:'GET',dataType:"json",data:'email='+emailVal,success:function(data){if(data!=true){valid=false
