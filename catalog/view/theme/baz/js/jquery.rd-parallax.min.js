    ...
    (function (d, q, l) {
        ...
        m = function () {
                    ...
                    a.$element.wrapInner(d("<div/>", {"class": "rd-parallax-inner"})).find(".rd-parallax-layer[data-type]").each(function () {
                        ...
                        switch (e.attr("data-type").toLowerCase()) {
                            case "media":
                                ...
                                a.$win.on(n ? "orientationchange" : "resize", d.proxy(a.resizeMedia, this, a))
                        }
                        a.$doc.on("scroll", d.proxy(a.moveLayer, this, a));
                        a.$doc.on("resize", d.proxy(a.moveLayer, this, a));
                        if ("true" === this.getAttribute("data-fade") && !k) a.$doc.on("scroll", d.proxy(a.fadeLayer, this, a));
                        if ("true" === this.getAttribute("data-fade") && !k) a.$doc.on("resize", d.proxy(a.fadeLayer,
                            this, a))
                    });
            ...
            b.prototype.moveLayer = function (a) {
                ...
                c = this.offsetHeight;
                parseFloat(g);
                g = ("inverse" === this.getAttribute("data-direction") ? -1 : "inverse" === a.options.layerDirection ? -1 : 1) * (this.getAttribute("data-speed") ? Math.min(parseFloat(this.getAttribute("data-speed")), 2) : a.options.layerSpeed);
                e = -(b - f) * g + (e - c) / 2 + (h - e) / 2 * g;
                return d(this).css(a.transform(e,
                    a))
            };
            ...
            b.prototype.blurMedia = function (a) {
                ...
                e = Math.ceil(Math.max(e / c,
                    f / b));
                return d(this).css(a.blur(e))
            };
            b.prototype.resizeMedia = function (a) {
                return this.style.height = a.px(a.getMediaHeight(l.innerHeight, a.$element.height(), this.getAttribute("data-speed") ? this.getAttribute("data-speed") : a.options.layerSpeed))
            };
            b.prototype.getMediaHeight = function (a, b, c) {
                c = Math.max(parseFloat(c), 0);
                c = Math.min(parseFloat(c), 2);
                return b + (1 >= c ? (a - b) * c : a * c)
            };
            ...
            b.prototype.transform = function (a, b) {
                return k &&
                10 > p ? {transform: "translate(0," + a + "px)"} : {
                    "-webkit-transform": "translate3d(0," + a + "px, 0)",
                    transform: "translate3d(0," + a + "px, 0)",
                    transition: n ? "" + b.options.layerDuration + "ms transform " + b.options.layerEasing : "none"
                }
            };
            b.prototype.blur = function (a) {
                return 2 < a ? {"-webkit-filter": "blur(" + a + "px)", filter: "blur(" + a + "px)"} : {
                    filter: "none",
                    "-webkit-filter": "none"
                }
            };
        ...
        d.fn.extend({
            RDParallax: function (b) {
                return this.each(function () {
                    var a;
                    a = d(this);
                    if (!a.data("RDParallax")) return a.data("RDParallax", new m(this,
                        b))
                })
            }
        });
        return l.RDParallax = m
