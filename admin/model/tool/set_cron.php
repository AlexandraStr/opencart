...
class ModelToolSetCron extends Model {
    ...
    {
        $sql2 = "INSERT INTO `" . DB_PREFIX . "cron_task` (`task_name`,`interval`,`time_begin`,`time_end`,`day_begin`,`day_end`,`dayofmonth`,`month`) 
        VALUES('" . $cron_date['task_name'] . "','" . $cron_date['interval'] . "','" .$cron_date['time_begin'] . "','" . $cron_date['time_end'] . "','" . $cron_date['day_begin'] . "','" .$cron_date['day_end'] . "','" . $cron_date['dayofmonth'] . "','" . $cron_date['month']."' )";
        $this->db->query($sql2);
    ...
    public function editTask($task_id, $cron_date) {
      $sql=("UPDATE `" . DB_PREFIX . "cron_task`
                SET `task_name` ='" .$cron_date['task_name']. "', `interval` = '" . $cron_date['interval'] . "', `time_begin` = '" .$cron_date['time_begin'] . "',
