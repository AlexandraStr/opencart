...
class ControllerExtensionNews extends Controller {
	...
	public function index() {
		...
		$pagination->url = $this->url->link('extension/news', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	protected function form() {
        ...
        $data['type_news_name'] = array();

        $type_news_name = $this->model_extension_news->getTypeNews();

        foreach ($type_news_name as $type_name) {
            $data['type_news_name'][] = array (
    ...
    //*******
        $data['text_type_news'] = $this->language->get('text_type_news');
        $data['text_type_shares'] = $this->language->get('text_type_shares');
        $data['text_type_developments'] = $this->language->get('text_type_developments');
   //*****
