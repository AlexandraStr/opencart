...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/customer_specials')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_customer_specials'),
                    'href'     => $this->url->link('catalog/customer_specials', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'tool/set_cron')) {
                $maintenance[] = array(
                    'name'	   => $this->language->get('text_set_cron'),
